main(List<String> args) {
  ...
  // regresa un true. Porque si teien una F
  ...
  print(
      'SubString: ${nombreCompleto.substring(0, 5)}...'); // para cortar partes del string
  print(
      'indexOf F: ${nombreCompleto.indexOf('F')}'); // Fernando - te devuele el index de la posicion. en este caso 0

  // segmentar o cortar.
  print('Split: ${nombreCompleto.split(' ')}'); // Fernando Herrera
  print('Split: ----${nombreCompleto.split(' ')[1]}----');

  // la ultima legra en mayuscula
  print(
